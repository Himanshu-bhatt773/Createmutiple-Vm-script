...
for i in anshosts:
    ...
    print (colors.fg.blue,"\n vmcreate_cmd output: \n{}".format(vmcreate_cmd),colors.reset)
    ...
    chansssh.sendline("")
    print (colors.fg.yellow,"\n Output of virsh console command: {}".format(chansssh.before.decode()),colors.reset)
...
EOF""".format(str(ipstart), str(ipstart), str(ipstart), str(ipstart), ipsetin, ipgw)
    print (colors.fg.green,"\n {}".format(netpconfig),colors.reset)
    chansssh.sendline(netpconfig)
    chansssh.expect(':~#')
    chansssh.sendline("netplan apply")
    time.sleep(5)
    print (colors.fg.yellow,"\n Output of netplan apply: {}".format(chansssh.before.decode()),colors.reset)
    chansssh.expect(':~#')
    chansssh.sendline("logout")
    print (colors.fg.blue,"\n Output for logout command: {}".format(chansssh.before.decode()),colors.reset)
    if chansssh.isalive():
...
for i in conthosts:
    ...
    chconssh.sendline("")
    print (colors.fg.yellow,"\n Output of virsh console command: {}".format(chconssh.before.decode()),colors.reset)
    print (colors.fg.green,"\n Instance console is ready for Login"),colors.reset
...
EOF""".format(str(ipstart), str(ipstart), str(ipstart), str(ipstart), ipsetin, ipgw)
    ...
    time.sleep(5)
    print (colors.fg.yellow,"\n Output of netplan apply: {}".format(chconssh.before.decode()),colors.reset)
    chconssh.expect(':~#')
...
for i in comphosts:
    ...
    chcompssh.sendline("")
    print (colors.fg.yellow,"\n Output of virsh console command: {}".format(chcompssh.before.decode()),colors.reset)
    print (colors.fg.green,"\n Instance console is ready for Login",colors.reset)
...
EOF""".format(str(ipstart), str(ipstart), str(ipstart), str(ipstart), ipsetin, ipgw)
    ...
    time.sleep(5)
    print (colors.fg.yellow,"\n Output of netplan apply: {}".format(chcompssh.before.decode()),colors.reset)
    chcompssh.expect(':~#')
    chcompssh.sendline("logout")
    print (colors.fg.blue,"\n Output of logout command: {}".format(chcompssh.before.decode()),colors.reset)         
...
for i in strhosts:
    ...
    chstrssh.sendline("")
    print (colors.fg.yellow,"\n Output of virsh console command: {}".format(chstrssh.before.decode()),colors.reset)
    print (colors.fg.green,"\n Instance console is ready for Login",colors.reset)
...
EOF""".format(str(ipstart), str(ipstart), str(ipstart), str(ipstart), ipsetin, ipgw)
    ...
    time.sleep(5)
    print (colors.fg.yellow,"\n Output of netplan apply: {}".format(chstrssh.before.decode()),colors.reset)
    chstrssh.expect(':~#')
    chstrssh.sendline("logout")
    print (colors.fg.blue,"\n Output of logout command: {}".format(chstrssh.before.decode()),colors.reset)         
    if chstrssh.isalive():
        print (colors.fg.blue,"\n The child process is still alive, closing connection to {}".format(i),colors.reset)
    #Incrementing the IP block within the for loop
    ipstart+=1
